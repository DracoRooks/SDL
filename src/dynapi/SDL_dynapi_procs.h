...
SDL_DYNAPI_PROC(bool,SDL_RenderCircle,(SDL_Renderer *a,const SDL_FCircle *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_RenderFillCircle,(SDL_Renderer *a,const SDL_FCircle *b),(a,b),return)
