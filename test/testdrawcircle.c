...
/* Simple program:  draw a hundred random circles and circle outlines on the screen. */
...
static void DrawCircles(SDL_Renderer *renderer)
{
    SDL_Rect viewport;
    ...
    SDL_FCircle circle = {(float)viewport.w / 2, (float)viewport.h / 2, 20};
    SDL_RenderCircle(renderer, &circle);
